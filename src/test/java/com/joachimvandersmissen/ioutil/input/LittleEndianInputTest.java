...
public class LittleEndianInputTest {
    ...
    public void testConstructors() throws IOException {
        byte[] bytes = {0, 1};
        try (Input input1 = new LittleEndianInput(new ByteArrayInputStream(bytes)); Input input2 = new LittleEndianInput(bytes)) {
    ...
    public void testReadUnsignedShort() throws IOException {
        try (Input input = new LittleEndianInput(new byte[]{0x00, 0x00, (byte) 0xFF, 0x7F, 0x00, (byte) 0x80, (byte) 0xFF, (byte) 0xFF})) {
    ...
    public void testReadUnsignedInt() throws IOException {
        try (Input input = new LittleEndianInput(new byte[]{0x00, 0x00, 0x00, 0x00, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, 0x7F, 0x00, 0x00, 0x00, (byte) 0x80, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF})) {
            Assertions.assertEquals(0L, input.readUnsignedInt());
    ...
    public void testReadUnsignedLong() throws IOException {
        try (Input input = new LittleEndianInput(new byte[]{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, 0x7F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, (byte) 0x80, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF})) {
